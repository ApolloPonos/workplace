...
public class Oyun3 {
	...
	public static String TeklifVer(int[] AcilanKutular, int[] ParaKutulari) {
		...
		return Long.toString((AcilmayanKutuToplami - AcilanKutuToplami)
				/ AcilanKutuSayisi);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		int[] para = { 1, 2, 5, 10, 25, 50, 100, 200, 300, 400, 500, 5000,
				10000, 15000, 25000, 50000, 75000, 100000, 150000, 250000,
				500000, 500000 };
		int[] ParaKutulari = new int[22];
		BufferedReader Klavye = new BufferedReader(new InputStreamReader(
				System.in));
		...
		do {
			...
			if (KutuNo % 2 == 0) {
				Mesaj("Banka Teklifi :"
						+ TeklifVer(AcilanKutular, ParaKutulari));
			}
